...
### Changed
- [#13](https://github.com/tolkiger/pipeline-factory/issues/13) - Revert to standardized inline buildspec in pipeline-factory for consistency across all websites

## [0.4.0] - 2026-03-08

### Changed
- [#10](https://github.com/tolkiger/pipeline-factory/issues/10) - Use buildspec.yml from repository instead of hardcoded buildspec for better flexibility

## [0.3.0] - 2026-03-08

### Changed
- [#9](https://github.com/tolkiger/pipeline-factory/issues/9) - Simplify pipeline naming convention from `website-pipeline-{name}-website` to `{name}`
